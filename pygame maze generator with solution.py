...
def carve_out_maze(x,y):
    ...
    while len(stack) > 0:                                          # loop until stack is empty                                           # slow program now a bit
        ...
        if len(cell) > 0:                                          # check to see if cell list is empty
            ...
            single_cell(x, y)                                     # use single_cell function to show backtracking image                                      # slow program down a bit
